...
var ctsapp = angular.module('ctsapp', ['ngRoute']);

ctsapp.config(['$routeProvider',function($routeProvider) {
...
ctsapp.controller('formCtrl', ['$scope', function($scope){
